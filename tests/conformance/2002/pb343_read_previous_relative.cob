      *> kb/Work PB343 — READ ... PREVIOUS on a file with RELATIVE organization, the 2002 leg.
      ...
      *> At --std 85 the whole program is rejected: negative/pb343-read-previous-relative-85.
       ...
       FILE-CONTROL.
           SELECT DEN ASSIGN TO "pb343d2.dat"
               ORGANIZATION IS RELATIVE
               ACCESS MODE IS DYNAMIC
               RELATIVE KEY IS D-K
               FILE STATUS IS D-ST.
           SELECT SPA ASSIGN TO "pb343s2.dat"
               ORGANIZATION IS RELATIVE
               ACCESS MODE IS DYNAMIC
               RELATIVE KEY IS S-K
               FILE STATUS IS S-ST.
           SELECT EMP ASSIGN TO "pb343e2.dat"
               ORGANIZATION IS RELATIVE
               ACCESS MODE IS DYNAMIC
               RELATIVE KEY IS E-K
               FILE STATUS IS E-ST.

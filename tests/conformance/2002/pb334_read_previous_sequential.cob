      *> kb/Work PB334 — READ ... PREVIOUS on a file with SEQUENTIAL organization, the 2002 leg.
      ...
      *> program assert. At --std 85 the whole program is rejected: negative/pb334-read-previous-85.
       ...
       FILE-CONTROL.
           SELECT SQF ASSIGN TO "pb334p2.dat"
               ORGANIZATION IS SEQUENTIAL
               ACCESS MODE IS SEQUENTIAL
               FILE STATUS IS WS-ST.
           SELECT VRF ASSIGN TO "pb334v2.dat"
               ORGANIZATION IS SEQUENTIAL
               FILE STATUS IS WS-V.
           SELECT EMF ASSIGN TO "pb334e2.dat"
               ORGANIZATION IS SEQUENTIAL
               FILE STATUS IS WS-E.
       DATA DIVISION.
       FILE SECTION.

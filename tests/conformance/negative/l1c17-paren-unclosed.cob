      ...
      *> ISO §8.3.5 4) — an unclosed left parenthesis
      ...
      *> The arithmetic expression opens a parenthesis that is never
      *> closed: not a balanced pair.  Pure-syntax rule, so the generic
      *> parse code is the diagnostic.

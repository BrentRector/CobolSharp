      ...
      *> ISO §9.3.8.2.3 rule 7 — the formal is strong type TU: identical
      *>   layout, other type-name
      ...
      *> Interface-2 = L1C05VI (SWAPT USING LK-P RETURNING LK-R, both
      *>   TYPE TT, TT a STRONG group of one PIC X(4)); interface-1 =
      *>   the object interface of L1C05VC, which IMPLEMENTS L1C05VI.

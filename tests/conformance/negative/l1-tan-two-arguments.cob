      ...
      *> ISO 15.89.2 general format, the COMPLEMENT of the shape:
      *> "<u>FUNCTION</u> <u>TAN</u> ( argument-1 )" shows exactly ONE
      ...
      *>
      *> The positive half of this format is l1_tan_format. A format
      *> test that only ever writes the LEGAL shape cannot
      ...
      *> Module member and 15.89.2 carries no edition-conditional

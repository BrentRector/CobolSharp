      ...
      *> kb/Work PB829 - the CLOSED ISO 13.4.6.2 general format.  ONE grammar rule -
      ...
      *> The 13.4.6.2 clause list was RENDERED from the printed page (PDF p376 / folio 346) before it was
      ...
      *> standard, and neither WIBBLE nor WOBBLE is a reserved word at any of them.
       ...
       FILE-CONTROL.
           SELECT SF ASSIGN TO "pb829sd.dat".
       DATA DIVISION.
       FILE SECTION.
       SD  SF WIBBLE WOBBLE.
       01 SREC PIC X(10).

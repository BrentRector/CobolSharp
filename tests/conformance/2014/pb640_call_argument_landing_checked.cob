      ...
      *>    declared length.
       ...
       MAIN-P.
           DISPLAY "A1"
           CALL "PB640CB14" AS NESTED USING BY CONTENT BIG
           DISPLAY "A2"
           CALL "PB640CC14" AS NESTED USING BY VALUE BIG
           DISPLAY "A3"
           CALL "PB640CB14" AS NESTED USING BY CONTENT FITS
           DISPLAY "A4"
           CALL "PB640CB14" AS NESTED USING BY REFERENCE FITS
           DISPLAY "A5"
           CALL "PB640CD14" AS NESTED USING BY VALUE 123456789012345678
           DISPLAY "A6"
           STOP RUN.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640CB14.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 E1 PIC +9(9).9(9).
       LINKAGE SECTION.
       ...
       M1.
           ...
           DISPLAY "REF=" E1
           GOBACK.
       END PROGRAM PB640CB14.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640CC14.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 E2 PIC +9(9).9(9).
       LINKAGE SECTION.
       ...
       M2.
           ...
           DISPLAY "VAL=" E2
           GOBACK.
       END PROGRAM PB640CC14.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640CD14.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 E3 PIC +9(4).99.
       LINKAGE SECTION.
       ...
       M3.
           ...
           DISPLAY "SML=" E3
           GOBACK.
       END PROGRAM PB640CD14.
       END PROGRAM PB640CA14.

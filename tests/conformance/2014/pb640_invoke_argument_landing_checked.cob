      ...
      *>    prints +000000123.456000000.
       ...
       01 OBJ USAGE OBJECT REFERENCE PB640IC14.
       ...
       MAIN SECTION.
       MAIN-P.
           INVOKE PB640IC14 "NEW" RETURNING OBJ
           DISPLAY "B1"
           ...
           DISPLAY "B5"
           STOP RUN.
       END PROGRAM PB640IA14.

       IDENTIFICATION DIVISION.
       CLASS-ID. PB640IC14 INHERITS FROM BASE.
       ENVIRONMENT DIVISION.
       CONFIGURATION SECTION.
       REPOSITORY.
           CLASS BASE.

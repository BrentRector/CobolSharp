      ...
      *> kb/Work PB336: all three organizations tested the absent-OPTIONAL arm BEFORE the
      *> '46' guard, so the second and every later READ re-reported '10'.
       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB336RD.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT OPTIONAL SQA ASSIGN TO "pb336sqa.dat"
               ORGANIZATION IS SEQUENTIAL
               FILE STATUS IS FS.
           SELECT SQP ASSIGN TO "pb336sqp.dat"
               ORGANIZATION IS SEQUENTIAL
               FILE STATUS IS PS.
           SELECT OPTIONAL RLA ASSIGN TO "pb336rla.dat"
               ORGANIZATION IS RELATIVE
               ACCESS MODE IS DYNAMIC
               RELATIVE KEY IS RK
               FILE STATUS IS RS.
           SELECT OPTIONAL IXA ASSIGN TO "pb336ixa.dat"

      ...
      *>    => ABCD.
       ...
       MAIN.
           ...
           MOVE "HELLO" TO DL
           CALL "PB640LD23" AS NESTED USING BY CONTENT DL
           CALL "PB640LM23" AS NESTED USING BY CONTENT A7
           STOP RUN.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640LI23.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 T.
       ...
       M1.
           ...
           DISPLAY "IDXLEG=[" WI "]"
           GOBACK.
       END PROGRAM PB640LI23.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640LN23.
       DATA DIVISION.
       LINKAGE SECTION.
       ...
       M2.
           ...
           GOBACK.
       END PROGRAM PB640LN23.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640LD23.
       DATA DIVISION.
       LINKAGE SECTION.
       ...
       M3.
           ...
           GOBACK.
       END PROGRAM PB640LD23.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640LM23.
       DATA DIVISION.
       LINKAGE SECTION.
       01 LM PIC X(4).
       ...
       M4.
           DISPLAY "MOVELEG=[" LM "]"
           GOBACK.
       END PROGRAM PB640LM23.
       END PROGRAM PB640LA23.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. PB640LF23.
       DATA DIVISION.
       LINKAGE SECTION.
       01 LF PIC 9(4).

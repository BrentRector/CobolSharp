...
| ◐ | 13 | I | HIGH | 11,12 | M4 (COBOL-2023) deltas + EC remnants + behavior rows — IN PROGRESS (branch phase-13-m4-2023, NOT merged; pushed through `0efb0d88`; conformance 3648/unit 311/char 33). DONE: Step-1 audit · Wave B EC-SIZE · Wave C 8/10 grammar constructs · **STOP/GOBACK exit-code (VCR 75)** · **EC-BOUND-OVERFLOW + REF-MOD raise (EC-BOUND surface CLOSED)** · **Wave F USE FOR DEBUGGING (VCR 7.17, parallel-worktree + adversarial-review)** · Wave G **8 pin-to-spec dispositions** · Wave H CONFORMANCE.md/SCREEN warning · Wave I partial review. REMAINING: Wave C grammar batch (SUPPRESS WHEN · PICTURE EDITING · PERFORM Fmt3) + Wave G CLASS A (numeric-edited VALUE 34/35/36/86 · MERGE-prohib 27 · EXCEPTION-FILE-arg 68/69 · I-O '04' 21) + Wave E (EXTERNAL) + Wave D (directives) + Wave H code half + REF-MOD-ZERO-LENGTH directive + final review→merge. Worklists: `PHASE-13-audit.md` + `PHASE-13-wave-c-scout.md` + `PHASE-13-remaining-waves-scout.md`; live resume = resume-prompt banner | [PHASE-13](rearchitecture/PHASE-13-m4-2023-ec-remnants-behavior-rows.md) |

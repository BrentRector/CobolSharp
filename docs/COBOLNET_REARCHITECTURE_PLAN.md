...
- **⛔ BATTERY REFERENCE — CURRENT: battery #61, 2026-09-06, on `61d13d3e` — train 18 (PB728+PB575, PB704, PB735, PB740 with its three §9.1.15 rows recorded PARTIAL, PB761) plus the #60 record and the notes 8–9 commit after it — run in a DETACHED WORKTREE cut at the batch head.**

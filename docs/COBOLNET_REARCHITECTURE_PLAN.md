...
- **⛔ BATTERY REFERENCE — CURRENT: battery #67, 2026-09-09, on `42ebf400` — train 25 — run in a DETACHED WORKTREE cut at the batch head.**
...
- **BATTERY REFERENCE — PREVIOUS (#66, superseded by #67 above): battery #66, 2026-09-09, on `16073192` — train 24 — run in a DETACHED WORKTREE cut at the batch head.**
  ✅ ALL GREEN — Conformance **6539 / 6539**, Unit **23075 / 23075** (the GPL corpus is present in the battery worktree), characterization **33 / 33**, guard witnesses green, NIST **364 MATCH / 0 REGRESSION** and audit CLEAN (the shipped `cobol` compiler), all three static audits 0, differential **1323 cases** with **0 PER-CASE FLIP(S)**. Battery #67 at the next train's head must be ALL GREEN with 0 flips.

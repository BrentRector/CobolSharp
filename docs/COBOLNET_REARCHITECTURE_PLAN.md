...
- **⛔ BATTERY REFERENCE — CURRENT: battery #46, 2026-09-05, on `dbdcb0d2` — landing train 3 (PB231's USAGE BIT third, PB485, PB230, PB236, PB235; DEVLOG 1474) — run in a DETACHED WORKTREE cut at the batch head.**
...
- **BATTERY REFERENCE — PREVIOUS (#45, superseded by #46 above): battery #45, 2026-09-05, on `b3aad3fc` — landing train 2 (PB473, PB204, PB205, PB206, PB207, PB208; DEVLOG 1468) — run in a DETACHED WORKTREE cut at the batch head, the first battery with PB473's guard evidence witnesses (phase 2a).**

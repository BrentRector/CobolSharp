...
- **⛔ BATTERY REFERENCE — CURRENT: battery #78, 2026-09-13, on `9cfab584` — PB877 (the battery #77 regression fix, landed alone on train 36) — run in a DETACHED WORKTREE cut at the batch head.**
...
- **BATTERY REFERENCE — PREVIOUS (#76, superseded by #78 above): battery #76, 2026-09-13, on `db68907f` — train 34 — run in a DETACHED WORKTREE cut at the batch head.**

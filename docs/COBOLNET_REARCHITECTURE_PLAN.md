...
- **⛔ BATTERY REFERENCE — CURRENT: battery #44, 2026-09-04, on `1d949007` — landing train 1 (PB203, PB201, PB470, PB193; DEVLOG 1460) plus the resume-day filings — run in a DETACHED WORKTREE cut at the batch head.**

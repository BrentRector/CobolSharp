...
- **⛔ BATTERY REFERENCE — CURRENT: battery #49, 2026-09-05, on `cbde3247` — golden-lane round 4 (19 spec-derived goldens, `63236244`; DEVLOG 1486) plus the four note commits behind it — run in a DETACHED WORKTREE cut at the batch head.**
...
- **BATTERY REFERENCE — PREVIOUS (#48, superseded by #49 above): battery #48, 2026-09-05, on `6eaa98cf` — landing train 5 (PB248, PB250, PB251, PB252; DEVLOG 1484) — run in a DETACHED WORKTREE cut at the batch head.**

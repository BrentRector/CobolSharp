...
> **MEASURED 2026-08-08 — this register discharges 19 of the 199** (`python scripts/spec/audit_annex_a1.py`
> reports it, and the numbers below are its output, not a hand count): items 2, **22**, **56**, 59, **112**,
> **135**, 158, **171**, **179**, **180**, **188**, **202**,
...
> Int128 intermediate) is documented voluntarily. **180 obligations remain** (`audit_annex_a1.py` is the

...
> **MEASURED 2026-08-08 — this register discharges 18 of the 199** (`python scripts/spec/audit_annex_a1.py`
> reports it, and the numbers below are its output, not a hand count): items 2, **22**, **56**, 59, **135**,
> 158, **171**, **179**, **180**, **188**, **202**,

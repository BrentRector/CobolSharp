...
- ISO/IEC 1989:2023 §14.9.14 — EXIT statement (bare EXIT = common end point/no-op; EXIT PERFORM [CYCLE]; EXIT PARAGRAPH; EXIT SECTION; SR9 SECTION-phrase-only-in-a-section, SR10 PARAGRAPH-phrase-only-in-a-paragraph; GR2 EXIT PROGRAM-as-CONTINUE when not under a caller)

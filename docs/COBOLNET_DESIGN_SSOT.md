...
- **Pre-1 (owner-gated, ISO §12 §13 of the brief):** resolve **Q9 Int128 timing** and **Q10 COMP-5 wrap** before
  flipping any typed numeric. Add `Int128`/`CobolInt` overloads to `CobolNum` (the monomorphic value engine, §6.1)
  and `WidePrecision` to `PicInfo`.

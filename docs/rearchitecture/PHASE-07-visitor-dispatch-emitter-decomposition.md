...
- **STATUS: ◐ IN PROGRESS @ Exec Step D (2026-07-11) — Steps 1–5, 7–12 executing (P5 ✅ + P6 ✅ preconditions all hold; premise audit vs the current tree first — the doc's anchors predate P5/P6).** Prior state:

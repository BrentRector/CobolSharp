...
| `docs/COMPLETION_ROADMAP_COUNCIL.md` | DESIGN | **ADVISORY (2026-07-03, DEVLOG 580)** — the 8-agent council's phase-by-phase roadmap to FINISH the compiler (G7 validator waves → M2 OO/residuals → M3 → M4 → matrix closure → G8 in 3 cuts). Upholds the SSOT §16 spine; its §3 = 7 proposed deltas, §5 = the 11-item owner decision packet. NOT owner-ratified — `resume-prompt.md` remains the live plan; fold ratified deltas into the canonical docs, then retire/re-banner this. |

...
5. **Keep the docs CURRENT in the same change set.** Every doc except `DEVLOG.md` describes the CURRENT compiler.
...
6. **Work autonomously.** Commit AND push every checkpoint, with a forensic commit message and a DEVLOG entry.

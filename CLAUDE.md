...
### Current State
- **Branch**: main; guard ALL GREEN — **1187 unit / 489 integration / 364 NIST** (`bash scripts/guard.sh`);
  baselines 0 FAIL*.
- **DEVLOG at entry 408.** M1 (COBOL-85) complete; M2 (COBOL-2002) in progress. **The data-model migration is

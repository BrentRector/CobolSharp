...
status snapshot here or in memory — the plan's §0 banner is the ONLY live resume point** (phases 00–13 done;
P14 in progress [Step 0 = the traceability inventory] → P15 legacy retirement → P16 CIL backend).

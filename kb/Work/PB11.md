...
blocked: false
blocked_by: []
spec_refs: [15.3, 15.3.1.1, 15.3.1.3, 15.3.2, 15.3.3.2, 15.3.3.7, 15.39, 15.39.3, 15.40.3, 15.41.3, 15.48.3, 15.5]
closes_rows: ["AR-15.38.3-2", "AR-15.39.3-2", "AR-15.40.3-2", "AR-15.40.3-4", "AR-15.40.3-7", "AR-15.41.3-2",
  "AR-15.41.3-3", "AR-15.41.3-5", "AR-15.41.3-6", "AR-15.48.3-2", "AR-15.79.3-2", "AR-15.92.3-2",
  "RV-15.38.4-1", "RV-15.40.4-1", "RV-15.40.4-3", "RV-15.41.4-1", "RV-15.41.4-2", "RV-15.41.4-3"]
...
> formats (four common-time shapes × local/UTC/offset), and §15.3.3.7's combined = date + `T` + time with **basic

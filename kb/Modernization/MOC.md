---
title: Modernization — Map of Content
area: modernization
status: draft
...
# 🗺 Modernization — Map of Content

The rearchitecture roadmap, the spec-first conformance campaign, and the audit machinery behind them.
...
- [[kb/Context/MOC]] — project history & goals.
- [[kb/Spec/Version Targeting]] — the version matrix validating the mission.
- [[kb/Architecture/MOC]] — the dual-backend mandate & legacy retirement.

...
# (94 NC + 42 IF + 12 SM + 4 IC + 59 SQ + 19 RL + 17 IX = 247 tests).
...
IX101A IX102A IX104A IX107A IX111A IX113A IX114A IX115A IX116A IX117A IX118A IX120A IX121A IX201A IX202A IX204A IX302M
"

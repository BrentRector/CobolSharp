...
# (94 NC + 42 IF + 12 SM + 4 IC + 59 SQ + 19 RL + 40 IX + 26 ST = 296 tests).
...
# ST124A (the second variable-length SORT chain). Keep each chain's members consecutive, producers ahead
# of consumers.
...
ST101A ST102A ST103A ST104A ST105A ST106A ST107A ST108A ST109A ST110A ST111A ST112M ST113M ST114M ST118A ST119A ST122A ST123A ST124A ST125A ST126A ST127A ST131A ST132A ST133A ST134A ST135A ST136A ST139A ST140A ST144A ST146A ST147A
"

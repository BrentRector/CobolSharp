...
# (94 NC + 42 IF + 12 SM + 4 IC + 59 SQ + 19 RL + 40 IX + 16 ST = 286 tests).
# ST chains: ST101A (builds the SORT output file TF002) -> ST102A (updates it; NO_OUTPUT producer, runs but
# is not baselined) -> ST103A (verifies). ST104A (builds TF001) -> ST105A (verifies). Keep each chain's
# members consecutive and producers ahead of consumers.
...
ST101A ST102A ST103A ST104A ST105A ST106A ST108A ST118A ST119A ST125A ST127A ST131A ST132A ST133A ST134A ST135A ST136A
"

...
- **Guard** (`bash scripts/guard.sh`): 1000 unit / 342 integration (341 pass + 1 unrelated skip) / **148 NIST baselines (94 NC + 42 IF + 12 SM)**. Must stay ALL GREEN; baselines must stay 0 FAIL*. (NC214M was dropped — live ACCEPT FROM DATE/DAY/TIME, inherently non-deterministic; DEVLOG 226.)

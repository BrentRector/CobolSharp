...
public class CobolLexer extends Lexer {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'COMP'", "'COMP-1'", "'COMP-2'", "'COMP-3'", "'COMP-5'", "'COMPUTATIONAL'", 
			"'COMPUTATIONAL-1'", "'COMPUTATIONAL-2'", "'COMPUTATIONAL-3'", "'COMPUTATIONAL-5'", 
			...
			"'EDITED'", "'ELSE'", "'END'", "'ENTRY'", "'EQUAL'", "'ERROR'", "'EXCEPTION'", 
			"'EXTEND'", "'EXTERNAL'", "'FIRST'", "'FOR'", "'FALSE'", "'FILE'", "'FILLER'", 
			"'POSITIVE'", "'NEGATIVE'", "'RESERVE'", "'FROM'", "'FUNCTION'", "'GENERIC'", 
			"'GIVING'", "'GLOBAL'", "'GREATER'", "'SYMBOLIC'", "'ALPHABET'", "'CRT'", 
			"'CURSOR'", "'CHANNEL'", "'PROCEED'", "'USE'", "'STANDARD'", "'REPORTING'", 
			"'SUM'", "'IN'", "'INDEX'", "'INDEXED'", "'INITIAL'", "'INPUT'", "'INSTALLATION'", 
			"'INTO'", "'INVALID'", null, "'JUST'", "'JUSTIFIED'", "'KEY'", "'LEADING'", 
			"'LEFT'", "'LESS'", "'LINE'", "'LINES'", "'METHOD'", "'MODE'", "'NEXT'", 
			"'NOT'", "'NUMERIC'", "'NULL'", "'OCCURS'", "'OF'", "'OFF'", "'ON'", 
			"'OR'", "'ORGANIZATION'", "'OTHER'", "'OUTPUT'", "'OVERFLOW'", "'PACKED'", 
			"'PARAGRAPH'", null, "'POINTER'", "'PREVIOUS'", "'PROGRAM'", "'RANDOM'", 
			"'RECORD'", "'RECURSIVE'", "'REDEFINES'", "'REPLACING'", "'REFERENCE'", 
			"'RELATIVE'", "'REMAINDER'", "'REMARKS'", "'RENAMES'", "'RETURNING'", 
			"'ROUNDED'", "'RIGHT'", "'RUN'", "'SECURITY'", "'SELECT'", "'SELF'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SELF", "SEPARATE", "SEQUENTIAL", "SIGN", "SIZE", "STATUS", "SUPER", 
	...
	private static final String _serializedATNSegment0 =
		...
		"\u0130\u0263\u0131\u0003\u0000\u0001\u0002%\u0003\u0000\t\n\r\r  \u0002"+
		"\u0000EEee\u0002\u0000NNnn\u0002\u0000DDdd\u0002\u0000IIii\u0002\u0000"+
		"FFff\u0002\u0000PPpp\u0002\u0000RRrr\u0002\u0000OOoo\u0002\u0000MMmm\u0002"+
		"\u0000VVvv\u0002\u0000AAaa\u0002\u0000LLll\u0002\u0000UUuu\u0002\u0000"+
		"TTtt\u0002\u0000SSss\u0002\u0000CCcc\u0002\u0000HHhh\u0002\u0000GGgg\u0002"+
		"\u0000WWww\u0002\u0000KKkk\u0002\u0000JJjj\u0002\u0000XXxx\u0002\u0000"+
		"BBbb\u0002\u0000YYyy\u0001\u0000  \u0002\u0000ZZzz\u0002\u0000QQqq\u0001"+

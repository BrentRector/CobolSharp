...
public static class ConstructRegistry
{
    ...
    [
        ...
        new("usage-pointer-2002", "USAGE POINTER", 2002, null, null, EditionCodes.Introduction, "ISO §13.18.60 / §8.5.2.6; the ManagedPointer carrier — LIVE (Phase-4b increment 1: SET TO NULL/pointer + equality, DEVLOG 613; ADDRESS OF/BASED/ALLOCATE are increment 2+); introduction gate 0900 below 2002"),

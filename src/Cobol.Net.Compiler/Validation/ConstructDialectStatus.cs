...
public static class ConstructRegistry
{
    ...
    [
        ...
        new("boolean-data-2002", "boolean data (PICTURE symbol 1 / USAGE BIT)", 2002, null, null, EditionCodes.Introduction, "ISO §8.5.2 category boolean / §13.18.40 / §13.18.60; LIVE (Phase 4a track (a)): compiles at 2002+, COBOLNET0900 below; one '0'/'1' char per position (GR14 R14, D-B1); the B-AND/B-OR/B-XOR/B-NOT operator leg is increment 2"),

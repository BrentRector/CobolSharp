...
public static class ConstructRegistry
{
    ...
    [
        ...
        new("usage-float-long-2002", "USAGE FLOAT-LONG", 2002, null, null, EditionCodes.Introduction, "ISO §13.18.60.4 GR13; D16 (Phase 6a) — the implementor-defined float trio; LIVE"),
        new("usage-float-extended-2002", "USAGE FLOAT-EXTENDED", 2002, null, null, EditionCodes.Introduction, "ISO §13.18.60.4 GR13; D16 (Phase 6a) — implementor-defined, mapped to double (no .NET quad; the GR13 subset nesting); LIVE"),
        ...
        // ── Phase 4c residue: function prototypes / separate compilation (M2-UDF-3; DEVLOG 624) ──
        new("function-prototype-2002", "a FUNCTION-ID … IS PROTOTYPE (separate-compilation function prototype)", 2002, null, null, EditionCodes.Introduction, "ISO §11.5 Format 2 / §10.6 / §12.3.8; LIVE (Phase 4c M2-UDF-3) — a signature-only unit (LINKAGE-only data + a header-only PD, §10.6.2 SR4) registers a signature but emits no runtime module; a separately-compiled definition is resolved by the run unit's sibling probe (§8.4.3.2.4 GR6b → EC-FUNCTION-NOT-FOUND on absence); the PROTOTYPE tail is {is2002()}?-gated + a W1.5 parse-layer 0900 mapping"),
        new("user-word-prototype-2002", "the word PROTOTYPE as a user-defined word", 85, 2002, null, EditionCodes.ReservedWord, "§8.9 interval encoding: user-definable at 85, reserved since 2002 (ReservedWords.Table row; cobolWord/_dataNameTokens/CheckedTokenTypes-admitted at the UDF-3 wave; the user-word-raising-2002 precedent)"),

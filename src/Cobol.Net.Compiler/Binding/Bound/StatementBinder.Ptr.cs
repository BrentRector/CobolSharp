...
public sealed partial class StatementBinder
{
    ...
    {
        ConstructRegistry.Check(data.Edition, "set-address-2002", "SET ADDRESS OF (ISO §14.9.39 Format 7)");
    ...
    {
        ConstructRegistry.Check(data.Edition, "allocate-2002", "ALLOCATE (ISO §14.9.3)");
    ...
    {
        ConstructRegistry.Check(data.Edition, "free-2002", "FREE (ISO §14.9.15)");
    ...
    private BoundStatement? PtrTryBindSetUpDown(Core.SetIndexStatementContext ud)
    {
        ...
        ConstructRegistry.Check(data.Edition, "pointer-arithmetic-2002", "SET pointer UP/DOWN BY (ISO §14.9.39 Format 10)");
